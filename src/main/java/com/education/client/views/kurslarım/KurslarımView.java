...
import com.vaadin.flow.router.Route;import com.education.client.views.main.MainView;


@Route(value = "my-courses", layout = MainView.class)
@PageTitle("Kurslarım")
@CssImport(value = "styles/views/kurslarım/kurslarım-view.css", include = "lumo-badge")
@JsModule("@vaadin/vaadin-lumo-styles/badge.js")
public class KurslarımView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public KurslarımView() {
        setId("kurslarım-view");
        addClassName("kurslarım-view");
        setSizeFull();
        grid.setHeight("100%");
