...
@Route(value = "new-category", layout = MainView.class)
@PageTitle("Kategori Ekle")
@CssImport("styles/views/kategoriekle/kategori-ekle-view.css")
public class KategoriEkleView extends Div {
    ...
    public KategoriEkleView() {
        setId("kategori-ekle-view");
